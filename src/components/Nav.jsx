      ...
      <div className="md:flex md:flex-col md:items-center">
        <a href="#home">
          <img
            ...
            alt="Profile Picture"
            className="w-10 rounded-full border-2 border-white md:border-4 md:border-primary md:w-28 md:h-28 md:mt-10 lg:w-44 lg:h-44"
          />
        </a>
      </div>
      ...
      <div className="relative md:w-full md:mt-10 md:flex-grow">
        {!isOpen ? (
          <svg
            ...
            strokeWidth="1.5"
            stroke="white"
            className="size-6 md:hidden gentleZoom"
            onClick={toggleMenu}
          >
            <path
              strokeLinecap="round"
